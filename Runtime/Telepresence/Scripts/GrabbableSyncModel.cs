...
[RealtimeModel]
public partial class GrabbableSyncModel
{
...
public partial class GrabbableSyncModel : RealtimeModel {
    public string key {
        get {
    ...
    public delegate void PropertyChangedHandler<in T>(GrabbableSyncModel model, T value);
    ...
    public GrabbableSyncModel() : base(null) {
