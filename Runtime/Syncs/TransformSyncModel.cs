...
using static ISyncModel; //NOTE: this is needed for the auto generated code to work

[RealtimeModel]
public partial class TransformSyncModel: ISyncModel
{
...
public partial class TransformSyncModel : RealtimeModel {
    ...
    public TransformSyncModel() : base(null) {
        ...
        _spawnUrlProperty = new ReliableProperty<string>(3, _spawnUrl);
        _spawnParentKeyProperty = new ReliableProperty<string>(4, _spawnParentKey);
    }
